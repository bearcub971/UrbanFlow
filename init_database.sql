...
CREATE TABLE dossiers_client (
    ...
    FOREIGN KEY (id_adresse_residence) REFERENCES adresses_client(id) ON DELETE CASCADE,
    FOREIGN KEY (id_adresse_facturation) REFERENCES adresses_client(id) ON DELETE CASCADE
);
